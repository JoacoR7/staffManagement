...
import EntityTable from './JustificacionTable'
import EntityForm from './JustificacionForm'
...
const ActualPage = () => {
  ...
  const [endpoint] = useState("justificacion")
...
return (
    <div className="container-fluid">
      ...
      <ConfirmModal
        ...
        mensaje={
          <p>
            ¿Estás seguro de que deseas eliminar la justificación <strong>{paraEliminar?.nombre}</strong>?
          </p>
        }
        textoBotonConfirmar= {`Eliminar ${endpoint}`}
      />
